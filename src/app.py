...
def run_react_agent(user_query: str, provider, mcp_server: MCPAcademicServer) -> list:
    ...
    while step < MAX_ITERATIONS:
        ...
        # Trường hợp 2: LLM đề xuất gọi Tool (Action)
            ...
            # =====================================================
            # ĐƯA OBSERVATION CHO LƯỢT LLM TIẾP THEO
            # =====================================================

            user_query = (
                f"{user_query}\n\n"
                f"Observation từ tool {tool_name}:\n"
                f"{obs_str}\n\n"
                f"Hãy dựa vào Observation trên để tiếp tục "
                f"suy luận và trả lời người dùng."
            )

            # QUAN TRỌNG:
            # Không break ở đây.
            # while sẽ chạy tiếp và gọi LLM lần nữa.
